...
pts2 <- pts
## Change the popup_text in that data
pts2@data$popup_text <- as.character(1:14)
...
layer1 <- point_layer(a, layer_title = "Layer 1")
layer2 <- point_layer(b, layer_title = "Layer 2", fillColor = shQuote("#ff0000"))
